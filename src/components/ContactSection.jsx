...
import { Phone, MessageCircle, Navigation, MapPin, Send, CheckCircle2 } from 'lucide-react';
...
export default function ContactSection() {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      setSubmitted(false);
      setFormData({ name: '', phone: '', type: 'Wholesale Inquiry', message: '' });
    }, 4000);
  };
          ...
          <div className="lg:col-span-6 bg-zinc-900 border border-zinc-800 rounded-3xl p-6 sm:p-8 shadow-2xl">
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-zinc-950 font-extrabold py-3.5 rounded-xl shadow-lg shadow-amber-500/20 transition-all hover:scale-[1.02]"
                >
