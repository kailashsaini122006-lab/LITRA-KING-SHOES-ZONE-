                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
                          ...
                          <div className="p-4 bg-zinc-900 border border-zinc-800 rounded-xl space-y-2">
                            ...
                            <div className="space-y-1 text-zinc-300">
                              ...
                              <p className="text-zinc-400">Distance: <span className="font-mono text-white">{ord.deliveryDistance || ord.deliveryDistanceKm || 0} km</span> | Charge: <span className="font-mono text-white">₹{ord.deliveryCharge || 0}</span></p>
                            </div>
                          </div>
